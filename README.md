...
This shows our entire network infrastructure is working. Our client has internet access, DHCP is issuing IP leasees, Active directory is documenting users, Domain controller natting and forwarding out to internet to proper echo/reply pings sent out.
